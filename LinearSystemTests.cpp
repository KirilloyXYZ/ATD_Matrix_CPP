...
static bool LinearAreClose(double left, double right, double epsilon = 1e-9)
{
    return std::fabs(left - right) <= epsilon;
}

static void AssertVectorClose(const Sequence<double>& actual, const Sequence<double>& expected, double epsilon = 1e-9)
{
